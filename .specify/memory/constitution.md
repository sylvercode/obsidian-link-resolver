...
Added principles:
- VII. Reproducible Development Environment (added)
- VIII. Continuous Integration & Release Gating (added)
Modified sections:
- Development Workflow (expanded with devcontainer and tagged-release gate expectations)
Added sections: none
...
**Version**: 1.2.0 | **Ratified**: 2026-09-17 | **Last Amended**: 2026-09-19
